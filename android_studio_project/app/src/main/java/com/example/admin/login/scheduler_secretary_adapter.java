...
public class scheduler_secretary_adapter extends RecyclerView.Adapter<scheduler_secretary_adapter.ScheduleruserViewHolder> implements PopupMenu.OnMenuItemClickListener {
    ...
    public class BackgroundWorker extends AsyncTask<String, Void , String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String action_url = "http://10.0.2.2/secretaryaction.php";
    ...
    public scheduler_secretary_adapter(Context sctx, List<Scheduleruser> list) {
        this.sctx = sctx;
        this.list = list;
    }
    ...
    @NonNull
    @Override
    public scheduler_secretary_adapter.ScheduleruserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(sctx);
        View view= inflater.inflate(R.layout.scheduler_layout,null);
        scheduler_secretary_adapter.ScheduleruserViewHolder holder = new scheduler_secretary_adapter.ScheduleruserViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final scheduler_secretary_adapter.ScheduleruserViewHolder holder, int position) {
        ...
        for( int j=0;j<a;j++){
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if((!txt.isEmpty())&&(!txt.equals("non working time"))){
    ...
    public void showPopup(View v, final String verif, final String sid, final String number){
        ...
        popup.getMenu().getItem(1).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                builder.setMessage("Are you sure to delete this appointment").setCancelable(false)
